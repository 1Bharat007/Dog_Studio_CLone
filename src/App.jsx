    ...
    <>
      <main>
        <div className="images">
          <img id="tomorowland" src="/models/tommorowland.png" alt="" />
        ...
        <section id="section-3">
          <div className="top">
            <div className="left">
              We' re crafting <br /> emotional <br /> experience aimed <br />
              at improving <br />
              results
            </div>
            <div className="right"></div>
          ...
          <div className="bottom">
            ...
            <div className="right">
              <p>
                Dogstudio is a design & technology <br /> firm working globally from <br />
                our offices based in Belgium and  <br />Chicago. Our strong focus on <br />
                producing high quality & emotional <br />
                 brandings, digital products <br />
                and experiences became a signature. <br />
              </p>

              <p>
                We’re passionate about moving <br /> people and solving problems for <br />
                the likes of Microsoft, The Museum <br /> of Science And Industry Of <br />
                Chicago, The Kennedy Center <br /> of Washington, Dragone, Quanta <br />
                Magazine, and many more. <br />
              </p>
            </div>
          </div>
        </section>
